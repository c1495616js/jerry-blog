...
```javascript title="multiply.js" showLineNumbers {2}
const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;
...
```js title="multiply.js" showLineNumbers {2}
const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;const multiply = (a, b) => a * b;
const multiply = (a, b) => a * b;
