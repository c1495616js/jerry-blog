    ...
    <div className="pb-10">
      ...
      {aboutPage && (
        <div className="container max-w-6xl">
          <h2 className="font-heading mb-8 text-4xl font-bold">Who&apos;s this girl again?</h2>
          <div className="grid grid-cols-1 place-items-start justify-between gap-12 lg:grid-cols-3">
            ...
            <div className="col-span-1 lg:col-span-2">
              <article className="prose dark:prose-invert prose-headings:mb-3 prose-headings:mt-8 prose-headings:font-heading prose-headings:font-bold prose-headings:leading-tight hover:prose-a:text-accent-foreground prose-a:prose-headings:no-underline mx-auto max-w-5xl">
